...
class OTAUpdater:
    def __init__(self, gitlab_repo, module='', main_dir='src'):
        self.http_client = HttpClient()
        self.gitlab_repo = gitlab_repo.rstrip('/').replace('https://github.com', 'https://api.github.com/repos')
    ...
    def _download_and_install_update(self, latest_version, ssid, password):
        ...
        self.download_all_files(self.gitlab_repo + '/contents/' + self.main_dir, latest_version)
    ...
    def get_latest_version(self):
        latest_release = self.http_client.get(self.gitlab_repo + '/releases/latest')
